...
namespace SimpleHtmlToPdf.Settings
{
    ...
    {
        /// <summary>
        /// The text to print in the right part of the header, note that some sequences are replaced
        ...
        /// <summary>
        /// The string to print in the left part of the header, note that some sequences are
        ...
        /// <summary>
        /// The amount of space to put between the header and the content, e.g. "1.8". Be aware that
        /// if this is too large the header will be printed outside the pdf document. This can be
        /// corrected with the margin.top setting. Default = 0.00
        /// </summary>
